...
define( 'CHILD_THEME_VERSION', '1.17' );
...
function mp_styles_scripts() {
 ...
 // wp_enqueue_style( 'main', CHILD_URL . '/css/main.min.css', array(), CHILD_THEME_VERSION );
 ...
 // wp_enqueue_style( 'kasra', CHILD_URL . '/css/kasra.css', array(), CHILD_THEME_VERSION );
  ...
  wp_enqueue_script( 'plusone.js', '//apis.google.com/js/plusone.js', array('jquery'), CHILD_THEME_VERSION, true );
...
//  wp_enqueue_script( 'plugins', CHILD_URL . '/js/plugins.js', array('jquery'), CHILD_THEME_VERSION, true );
  ...
  // Combined and Minified version
  wp_enqueue_script( 'script', CHILD_URL . '/js/script.min.js', array('jquery'), CHILD_THEME_VERSION, true );
}
...
function rewrite_urls() {
    ...
    add_rewrite_rule( '^topic/([^/]+?)/([^/]+?)/?$', 'index.php?category=$matches[1]&subcategory=$matches[2]', 'top' );
