...
if( !class_exists( 'contentTypeTaxonomy' ) ) {
	require_once( dirname(__FILE__) . '/MPPlugin.php' );

	class contentTypeTaxonomy extends MPPlugin {
		const MP_CONTENT_TYPE_TAXONOMY_VERSION = 0.1;

		public function __construct() {
			parent::__construct( 'contentTypeTaxonomy', self::MP_CONTENT_TYPE_TAXONOMY_VERSION );
